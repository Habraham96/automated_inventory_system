<?php
// Shared preloader include for BRM views
// Usage: include 'layouts/preloader.php' from inside brm/*
?>
<!-- Preloader -->
<div id="preloader" style="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:#fff;z-index:99999;transition:opacity 0.35s ease;">
  <div class="spinner" style="width:72px;height:72px;border-radius:50%;border:8px solid rgba(102,126,234,0.12);border-top-color:#667eea;animation:spin 1s linear infinite;"></div>
</div>
<script>
