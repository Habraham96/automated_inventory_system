...
function openAddCustomerPanel() {
  ...
  const backdrop = document.getElementById('addPanelBackdrop');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (addCustomerForm) {
    addCustomerForm.addEventListener('submit', function(e) {
      ...
      // For now, just show a success alert and close the panel
...
<html lang="en">
  <head>
    ...
    .add-panel-backdrop.show {
      opacity: 1;
      visibility: visible;
    }
    
    /* Modal z-index and backdrop fixes for edit modal */
    .modal-backdrop {
  ...
  <body class="with-welcome-text">
                ...
                <div class="card card-rounded">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <button type="button" class="btn btn-primary" style="min-width: 150px;" onclick="openAddCustomerPanel()"><strong>+ Add Customer</strong></button>
                    </div>
    ...
    <!-- Add Customer Side Panel -->
    <div class="add-panel-backdrop" id="addPanelBackdrop" onclick="closeAddCustomerPanel()"></div>
    ...
    <div class="add-customer-panel" id="addCustomerPanel">
      <div class="customer-details-header">
        ...
        <button type="button" class="close-details-btn" onclick="closeAddCustomerPanel()">
          <i class="bi bi-x-lg"></i>
        </button>
      </div>
      ...
      <div class="panel-body" style="padding: 2rem;">
        <form id="addCustomerForm">
          ...
          <div class="d-flex gap-2 mt-4">
            <button type="button" class="btn btn-secondary flex-fill" onclick="closeAddCustomerPanel()" style="padding: 0.75rem;">
